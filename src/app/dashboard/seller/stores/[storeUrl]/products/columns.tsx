              ...
              <div key={variant.id} className="flex flex-col gap-y-2 group">
                <div className="relative cursor-pointer ">
                  ...
                  <div className="flex mt-2 gap-2 p-1">
                    ...
                    <div>
                      {/* Name of Variant */}
                      <h1 className="max-w-40 capitalize text-[16px] font-medium">
                        {variant.variantName}
                      </h1>
                      {/* Sizes*/}
                      <div className="flex flex-wrap gap-2 max-w-72 mt-1 ">
                        {variant.sizes.map((size) => (
                          <span
                            key={size.size}
                            className="w-fit p-1 rounded-md text-md font-medium border-2 bg-white/10"
                          >
                            {size.size} - ({size.quantity}) - {size.price} DA
                          </span>
                        ))}
                      </div>
                    </div>
      ...
      <AlertDialogContent className="max-w-lg">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-left">
            ...
            product and variant that exist inside product.
          </AlertDialogDescription>
        </AlertDialogHeader>
