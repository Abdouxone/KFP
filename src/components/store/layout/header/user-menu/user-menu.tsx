...
export default async function UserMenu() {
  ...
  return (
    <div className="relative group px-2">
      ...
      <div
        className={cn(
          "hidden absolute top-0 -left-20 cursor-pointer group-hover:block",
        ...
        <div className="relative left-2 mt-10 right-auto bottom-auto pt-2.5 text-[#222] p-0 text-sm z-40">
          ...
          <div className="rounded-3xl bg-white text-sm text-[#222] shadow-lg">
            <div className="w-[305px]">
              <div className="pt-5 px-6 pb-0 ">
                {user ? (
                  ...
                  <div className="space-y-1">
                    ...
                    <Link
                      href="/sign-up"
                      className="h-10 text-sm hover:underline text-main-primary flex items-center justify-center"
                    >
                      Register
                    </Link>
                  </div>
              ...
              {/* Links */}
              <div className="max-w-[calc(100vh -180px)] text-main-secondary overfly-y-auto overflow-x-hidden pt-0 px-2 pb-4">
