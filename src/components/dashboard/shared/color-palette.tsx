...
interface ColorPaletteProps {
  ...
  setColors: Dispatch<SetStateAction<{ color: string }[]>>; // Function to update colors
}
...
const ColorPalette: FC<ColorPaletteProps> = ({
  ...
  //State to tack the active color
  ...
  return (
    <div className="pt-10 w-[320 px] h-[160px] rounded-b-md overglow-hidden">
